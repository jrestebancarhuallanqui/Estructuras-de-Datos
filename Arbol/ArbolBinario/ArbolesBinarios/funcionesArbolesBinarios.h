...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol *, NodoGen, 
                                                          struct NodoArbol *);
void plantarArbolBinario(struct ArbolBinario &, struct NodoArbol *, NodoGen,
                                                       struct NodoArbol * );
void plantarArbolBinario(struct ArbolBinario &, struct ArbolBinario &, NodoGen,
                                                struct ArbolBinario &);
//NodoGen raiz(struct NodoArbol * nodo);

...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol * izquierdo, 
                               NodoGen elemento, struct NodoArbol * derecho){
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario & arbolIzquierdo,
                         NodoGen elemento, struct ArbolBinario & arbolDerecho){
...
void imprimeNodo(struct NodoArbol * nodo){
    cout<<setw(5)<<nodo->elemento.cantidad<<"-"<<nodo->elemento.cromo<<" ";
}
...
int alturaRecursivo(struct NodoArbol * nodo){
    if(esNodoVacio(nodo))
        return 0;
    return 1 + maximo( alturaRecursivo(nodo->izquierda), 
...
int numeroNodosRecursivo(struct NodoArbol * nodo){
    if(esNodoVacio(nodo))
        return 0;
    return 1 + numeroNodosRecursivo(nodo->izquierda) + 
                numeroNodosRecursivo(nodo->derecha);   
}
